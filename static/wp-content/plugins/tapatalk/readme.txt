...
* Bug fix for installation issue with previous version

= 1.3.2 =

* Bug fix for plugin compatibility

= 1.3.1 =

* Add app indexing option
* Bug fix and compatibility enhancement

= 1.3.0 =

* Supported Disqus comments display
* Fixed some content display issue

= 1.2.1 =

* Fixed image display issue in certain case
* Supported images display from 'Photo Gallery' plugin
* Optimized blog preview image logic

= 1.2.0 =

* Add tag information in blog list and blog details interface.
* Removed welcome screen page and settings.
* Fixed some content display issue.
