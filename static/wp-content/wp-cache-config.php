...
$cache_page_secret = '116c7717a492e92c6d1ede45cb78ccac'; //Added by WP-Cache Manager
...
$cache_path = '/data/web/techan.fr/wordpress/wp-content/cache'; //Added by WP-Cache Manager
$file_prefix = 'wp-cache-';
$ossdlcdn = 0;

// Array of files that have 'wp-' but should still be cached
$cache_acceptable_files = array ( 0 => 'wp-comments-popup.php', 1 => 'wp-links-opml.php', 2 => 'wp-locations.php', 3 => 'xmlrpc.php', ); //Added by WP-Cache Manager

$cache_rejected_uri = array ( 0 => 'wp-.*\\.php', 1 => 'index\\.php', 2 => 'xmlrpc.php', ); //Added by WP-Cache Manager
...
$sem_id = 1162677895; //Added by WP-Cache Manager
...
$wp_super_cache_front_page_text = 'Chercher'; //Added by WP-Cache Manager
