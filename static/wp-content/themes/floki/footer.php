...
<script>
  document.addEventListener('DOMContentLoaded', function(event) {
    cookieChoices.showCookieConsentBar('Bienvenue sur TechAN.fr, nous utilisons des cookies dans le but de pouvoir améliorer votre expérience sur ce site.',
      'Okay !', 'En savoir plus', 'https://techan.fr/disclaimer/');
  });
</script>
	</body>
</html>