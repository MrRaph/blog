...
next_posts_link('<div style="float:right; margin:50px;" class="pagination button">'.__('Articles plus anciens &raquo;',  'floki').'</div>'); 
?>


<?php 
previous_posts_link('<div style="float:left; margin:50px;" class="pagination button">'.__('&laquo; Articles plus récents', 'floki').'</div>'); 
