                ...
                <p>
						...
						<?php if (('open' == $post-> comment_status) && ('open' == $post->ping_status)) {
							// both comments and pings open ?>
							 <?php _e( 'You can', 'floki' ); ?> <a href="#respond"><?php _e( 'leave a response', 'floki' ); ?></a>, ou faire un <a href="<?php trackback_url(); ?>" rel="trackback"><?php _e( 'trackback', 'floki' ); ?></a> <?php _e( 'from own site', 'floki' ); ?>.
